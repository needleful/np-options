...
func _ready():
	$value/hue.connect("value_changed", Callable(self, "_on_hue_value_changed"))
	$value/sat.connect("value_changed", Callable(self, "_on_sat_value_changed"))
	$value/val.connect("value_changed", Callable(self, "_on_val_value_changed"))
